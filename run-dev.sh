...
# Development script to run the backend with Railway database connection
...
export TWILIO_PHONE_NUMBER="${TWILIO_PHONE_NUMBER:-your_phone_number_here}"  # Your Twilio phone number
